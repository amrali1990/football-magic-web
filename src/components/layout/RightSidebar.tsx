...
/**
 * Home-page right sidebar: the mobile-app promo on top, then the top 5
 * leagues and top 5 teams playing on the selected date (HomeClient publishes
 * the date via SidebarScope).
 */
  ...
  return (
    <div className="sticky top-0 h-screen overflow-y-auto py-5 ps-6 pe-4 scrollbar-hide">
      <div className="space-y-4">
        ...
        {/* Top Leagues (for the selected date) */}
        {leagues.length > 0 && (
        ...
        {/* Top Teams (for the selected date) */}
        {teams.length > 0 && (
          <div className="overflow-hidden rounded-2xl bg-gradient-to-b from-gray-50 to-white ring-1 ring-gray-200/80">
            <div className="px-5 pt-5 pb-1">
              <div className="flex items-center gap-2.5">
